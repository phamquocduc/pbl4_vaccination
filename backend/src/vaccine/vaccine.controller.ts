...
export class VaccineController {
    ...
    async update(
        ...
        return this.vaccineSevices.updateVaccine(
            Number.parseInt(id),
            updateDto
        );
    }
    ...
    async updateVaccineDescription(
        @Param('id') id: string,
        @Body() updateDto: VaccineDescriptionUpdateDto
    ): Promise<VaccineDescription> {
        return this.vaccineSevices.updateVaccineDescription(
            Number.parseInt(id),
            updateDto
        );
    }
